...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('styleadmin/img/svg/logo.svg')}}" type="image/x-icon">
    <!-- Custom styles -->
    <link rel="stylesheet" href="{{asset('styleadmin/css/style.min.css')}}">
</head>
...
<body>
    ...
    <!-- Chart library -->
    <script src="{{asset('styleadmin/plugins/chart.min.js')}}"></script>
    <!-- Icons library -->
    <script src="{{asset('styleadmin/plugins/feather.min.js')}}"></script>
    <!-- Custom scripts -->
